...
<li id="post-<?php echo $content->id; ?>" class="<?php echo $content->css_class(); ?>" itemscope
	...
	<a href="<?php echo $content->info->url; ?>" rel="<?php echo $content->xfn_relationships; ?>"
	   title="Link: <?php echo $content->title_out; ?>"><span itemprop="name"><?php echo $content->title_out; ?></span></a>
	<?php if ($content->xfn_relationships) : ?>
		<br><span class="meta"><abbr
				title="XHTML Friend Network">xfn</abbr>: <?php echo implode(', ', preg_split("/[\s,]+/", $content->xfn_relationships)); ?></span>
	<?php endif; ?>
</li>
