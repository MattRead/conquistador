...
<header id="post-<?php echo $content->id; ?>"
        class="post type-<?php echo $content->typename; ?> status-<?php echo $content->statusname; ?>">
...
<?php if ($content->project->platform == 'habari'): ?>
	<p>
		...
		<?php if ($content->project->screenshot_url): ?>
			<img class="card right" src="<?php echo $content->project->screenshot_url; ?>"
			     alt="Screenshot of the Scientist theme">
		<?php endif; ?>
...
<table id="releases" style="font-size:14px;">
	...
	<?php foreach ($tags as $tag): ?>
		<tr>
			...
			<td>
				<a href="<?php echo $tag->zipball_url; ?>"
				   title="Download a zip of the <?php echo $content->project->type; ?>">ZIP</a>
			</td>
		</tr>
	<?php endforeach; ?>
	</tbody>
