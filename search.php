...
<h1>
	Search &ndash;
	<small>&#8220;<?php echo htmlentities($criteria, ENT_COMPAT, 'UTF-8', false); ?>&#8221;</small>
	<?php if ($page > 1) : ?>
...
<form method="get" id="searchform" action="<?php URL::out('display_search'); ?>">
	<p>
		<input type="text" id="s" name="criteria"
		       value="<?php echo htmlentities($criteria, ENT_COMPAT, 'UTF-8', false); ?>"><input type="submit"
		                                                                                         id="searchsubmit"
		                                                                                         value="Search">
	</p>
</form>
...
<?php else : ?>
	<p>Your search - <b><?php echo htmlentities($criteria, ENT_COMPAT, 'UTF-8', false); ?></b> - did not match any
		documents.
	<p>Suggestions:</p>
	<ul>
